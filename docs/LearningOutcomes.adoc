...
* `Override` the `getPrintableString` in classes `Name`, `Phone`, `Email`, and  so that each produces a printable string representation of the object. e.g. `Name: John Smith`, `Phone: 12349862`
