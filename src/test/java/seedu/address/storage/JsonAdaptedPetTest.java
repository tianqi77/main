...
public class JsonAdaptedPetTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPet pet =
                ...
                new JsonAdaptedPet(INVALID_NAME, VALID_GENDER, VALID_DOB, VALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPet pet = new JsonAdaptedPet(
                ...
                null, VALID_GENDER, VALID_DOB, VALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_invalidGender_throwsIllegalValueException() {
        JsonAdaptedPet pet =
                ...
                new JsonAdaptedPet(VALID_NAME, INVALID_GENDER, VALID_DOB, VALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_nullGender_throwsIllegalValueException() {
        JsonAdaptedPet pet = new JsonAdaptedPet(
                ...
                VALID_NAME, null, VALID_DOB, VALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_invalidDateOfBirth_throwsIllegalValueException() {
        JsonAdaptedPet pet =
                ...
                new JsonAdaptedPet(VALID_NAME, VALID_GENDER, INVALID_DOB, VALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_nullDateOfBirth_throwsIllegalValueException() {
        JsonAdaptedPet pet = new JsonAdaptedPet(
                ...
                VALID_NAME, VALID_GENDER, null, VALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_invalidSpecies_throwsIllegalValueException() {
        JsonAdaptedPet pet =
                ...
                new JsonAdaptedPet(VALID_NAME, VALID_GENDER, VALID_DOB, INVALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_nullSpecies_throwsIllegalValueException() {
        JsonAdaptedPet pet = new JsonAdaptedPet(
                ...
                VALID_NAME, VALID_GENDER, INVALID_DOB, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPet pet =
                ...
                new JsonAdaptedPet(VALID_NAME, VALID_GENDER, VALID_DOB, VALID_SPECIES, invalidTags);
        assertThrows(IllegalValueException.class, pet::toModelType);
    }
